...
<section class="flex flex-col gap-8 pb-24 lg:flex-row lg:justify-between lg:px-28 lg:gap-28 lg:mb-28">
    <article class="bg-secondary py-10 px-6 rounded-lg shadow-md lg:w-full lg:py-16">
        <div class="flex flex-col gap-3 mb-4">
            <label class="rounded-3xl" class="font-semibold lg:text-xl" for="income">Input Your Income</label>
            <input class="rounded-3xl" class="rounded-3xl" type="number">
        </div>
        <div class="flex flex-col gap-3 mb-4 lg:gap-6">
            <label class="rounded-3xl" class="font-semibold lg:text-xl" for="income">Add Your Exspenses Categories</label>
        ...
        <div class="flex items-center">
            <input  class="rounded-3xl" type="text" name="new-value" placeholder="Kategori baru" class="flex-1" />
            <button
        ...
        <button class="mt-8 btn-primary w-full">Calculate My Budget</button>
    </article>

    <article class="bg-secondary py-10 px-6 rounded-lg shadow-md lg:w-full">
        <p class="text-center font-semibold mb-8 lg:text-xl">Your Monthly Budget Breakdown</p>

        <table class="w-full text-sm lg:text-lg">
            <!-- Header -->
            <thead>
                <tr class="bg-primary text-white text-left">
                    <th class="px-4 py-3 rounded-tl-lg">Category</th>
